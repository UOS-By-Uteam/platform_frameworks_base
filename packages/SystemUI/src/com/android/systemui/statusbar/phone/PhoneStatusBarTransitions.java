...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mConnectionSpeed;
    ...
    public void init() {
        ...
        mConnectionSpeed = mView.findViewById(R.id.connectionSpeed);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mConnectionSpeed, newAlpha),
            ...
            mConnectionSpeed.setAlpha(newAlpha);
